  ...
  <div class="reports">
    ...
    <div v-else>
      ...
      <div class="stats-grid">
        <div class="stat-card">
          <div class="stat-label">{{ t('reports.ytdRevenue') }}</div>
        ...
        <div class="stat-card">
          <div class="stat-label">{{ t('reports.ytdOrders') }}</div>
...
export default {
  ...
  setup() {
    ...
    const getChangeValue = (current, previous) => {
      ...
      const absFormatted = formatCurrency(Math.abs(change), currentCurrency.value)
      if (change > 0) return `+${absFormatted}`
      if (change < 0) return `-${absFormatted}`
      return absFormatted
    }
